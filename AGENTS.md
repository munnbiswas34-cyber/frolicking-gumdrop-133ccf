# AGENTS.md — INAYA ENTERPRISES Project

Currency exchange landing page for INAYA ENTERPRISES. Single-page React application built on TanStack Start, deployed on Netlify.
